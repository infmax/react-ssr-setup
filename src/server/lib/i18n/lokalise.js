...
// { detect_icu_plurals: 1, convert_placeholders: 1, replace_modified: 0, lang_iso:
// process.env.SOURCE_LANGUAGE, file: translationsFile, }, { headers: { 'content-type':
// 'application/json', 'X-Api-Token': process.env.LOKALISE_TOKEN, }, } );
